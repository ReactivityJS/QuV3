 ...
 * `get(path)`/`put(path, val)` facade here on purpose (see docs/v5-concept.md's
...
export class Space {
   ...
   *   `storage` = optional; omitting it is the "flüchtig/memory-only" tier (see docs/v5-concept.md) - a Node still syncs live, nothing survives a reload.
   */
